...
## What I Do
- **Agentic AI:** CrewAI, n8n, Vertex AI multi-agent frameworks
- **LLM Integration:** Claude API with MCP, Novamira MCP for WordPress
...
- [Agentic AI Academy](https://academy.ultimedia.co.za/)
